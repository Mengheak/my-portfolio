<template>
  <div
    class="min-h-screen relative overflow-hidden bg-gradient-to-br from-black via-gray-900 to-black"
  >
    <div class="absolute inset-0 overflow-hidden opacity-30">
      ...
      >
        <div
          class="w-0.5 h-8 bg-gradient-to-b from-blue-400 via-green-400 to-transparent opacity-60"
        ></div>
      </div>
    </div>
    ...
    >
      <div
        class="flex flex-col xl:flex-row items-center justify-between gap-8 lg:gap-16"
      >
        <div class="flex-1 space-y-6 lg:space-y-8 text-center xl:text-left">
          ...
          >
            <div class="flex flex-col space-y-2">
              <span
                ...
                :style="{
                  transform: `translateX(${parallaxValues.tagline}px)`,
                }"
              >
                &lt; Hello World /&gt;
              </span>
              <h1
                class="text-4xl sm:text-5xl md:text-6xl xl:text-7xl font-black leading-tight"
              >
                <span
                  class="block text-white mb-2"
                  :style="{
                    transform: `translateX(${parallaxValues.hiText}px)`,
                  }"
                >
                  Hi, I'm
                </span>
                <span
                  :class="`block text-transparent bg-clip-text bg-gradient-to-r from-blue-400 via-green-400 to-blue-400 ${
            ...
            <div class="space-y-4">
              <p
                ...
                :style="{
                  transform: `translateY(${parallaxValues.description}px)`,
                }"
              >
                A passionate
                <span class="relative inline-block group">
                  <span
                    class="text-white font-bold bg-gradient-to-r from-blue-400 via-green-400 to-blue-400 bg-clip-text text-transparent"
                  >
                    Full Stack Developer
                  </span>
                  <span
                    class="absolute -bottom-1 left-0 w-0 h-0.5 bg-gradient-to-r from-blue-400 to-green-400 group-hover:w-full transition-all duration-500"
                  ></span>
                </span>
                crafting cutting-edge digital experiences with modern
                technologies.
              </p>
              ...
              <div
                ...
                :style="{
                  transform: `translateX(${parallaxValues.statusBadges}px)`,
                }"
              >
            ...
            <span
              ...
              :style="{
                ...
                transform: `translateY(${
                  parallaxValues.skills + index * 2
                }px) scale(1)`,
              }"
            >
              <div
                class="relative overflow-hidden px-4 py-2 rounded-xl bg-gray-900/50 backdrop-blur-sm border border-gray-700/50 hover:border-blue-400/50 hover:bg-gradient-to-r hover:from-blue-500/10 hover:to-green-500/10 transition-all duration-300"
              >
                <div
                  class="absolute inset-0 bg-gradient-to-r from-blue-400/0 via-green-400/20 to-blue-400/0 transform -translate-x-full group-hover:translate-x-full transition-transform duration-700"
                ></div>
                <span
                  class="relative text-sm font-medium text-gray-300 group-hover:text-white transition-colors z-10"
                >
                  {{ skill }}
                </span>
              </div>
          ...
          >
            ...
            >
              <span
                class="relative flex items-center justify-center gap-2 z-10"
              >
                <svg
          ...
          >
            <a
              ...
              :style="{
                transitionDelay: `${index * 0.1}s`,
                transform: `translateY(${
                  parallaxValues.social + index * 1.5
                }px) scale(1)`,
              }"
            >
              <div
                class="absolute inset-0 bg-gradient-to-br from-blue-400/0 to-green-400/0 group-hover:from-blue-400/10 group-hover:to-green-400/10 rounded-xl transition-all duration-300"
              ></div>
              <svg
        ...
        <div class="flex-1 flex justify-center xl:justify-end">
          ...
          >
            <div
              ...
              :style="{
                transform: `rotate(${parallaxValues.profileRings}deg)`,
              }"
            >
              <div
                class="absolute inset-0 rounded-full border border-blue-400/20"
                style="animation: spin 20s linear infinite"
              ></div>
              <div
                class="absolute inset-4 rounded-full border border-green-400/20"
                style="animation: spin 15s linear infinite reverse"
              ></div>
              <div
                class="absolute inset-8 rounded-full border border-blue-400/10 animate-pulse"
              ></div>
            </div>
            ...
            <div class="relative">
              ...
              >
                <div
                  class="w-full h-full rounded-3xl bg-gradient-to-br from-gray-900 to-black p-2"
                >
                  <div
                    class="w-full h-full bg-gradient-to-br from-gray-700 to-gray-800 rounded-2xl flex items-center justify-center text-gray-400 text-lg"
                  >
                    Profile Image
                  </div>
                </div>
              ...
              <div
                ...
                :style="{
                  transform: `translateY(${parallaxValues.profileDots}px)`,
                }"
              >
                <div
                  class="w-4 h-4 bg-green-400 rounded-full border-2 border-black shadow-lg animate-pulse"
                ></div>
                <div
                  class="w-3 h-3 bg-blue-400 rounded-full border-2 border-black shadow-lg animate-bounce opacity-80"
                ></div>
              </div>
              ...
              <div
                ...
                :style="{
                  transform: `translateY(${parallaxValues.profileAccent2}px)`,
                }"
              ></div>
              ...
              <div
                ...
                :style="{
                  transform: `translateX(-50%) translateY(${parallaxValues.codeSnippet}px)`,
                }"
              >
    ...
    <div
      ...
      :style="{
        transform: `translateX(-50%) translateY(${parallaxValues.scrollIndicator}px)`,
      }"
    >
      <div
        class="w-6 h-10 border-2 border-green-400/50 rounded-full flex justify-center"
      >
  ...
  setup() {
    ...
    const handleMouseMove = (e) => {
      ...
      if (floatingShape1.value) {
        floatingShape1.value.style.transform = `translateY(${
          parallaxValues.shape1
        }px) translateX(${mouseX * 10}px) rotate(45deg)`;
      }

      if (floatingShape2.value) {
        floatingShape2.value.style.transform = `translateY(${
          parallaxValues.shape2
        }px) translateX(${mouseX * -15}px)`;
      }

      if (floatingShape3.value) {
        const rotation = parallaxValues.rotation + mouseX * 5;
        floatingShape3.value.style.transform = `translateY(${
          parallaxValues.shape3
        }px) translateX(${mouseX * 20}px) rotate(${rotation}deg)`;
      }
    };
